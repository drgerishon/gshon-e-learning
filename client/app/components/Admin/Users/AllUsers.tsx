...
const AllUsers: FC<Props> = (Props) => {
  ...
  const [deleteUser, {isSuccess, error:deleteError}] = useDeleteUserMutation({})

  const { data, error, isLoading , refetch} = useGetAllUsersQuery({}, {refetchOnMountOrArgChange: true});
